...
#ifndef TRUTH_CONSENSUS_PARAMS_H
#define TRUTH_CONSENSUS_PARAMS_H
...
enum DeploymentPos
{
    ...
    DEPLOYMENT_ASSETS, // Deployment of TIP2
    DEPLOYMENT_MSG_REST_ASSETS, // Delpoyment of TIP5 and Restricted assets
...
#endif // TRUTH_CONSENSUS_PARAMS_H
