...
#ifndef TRUTHCOIN_ASSET_PROTOCOL_H
#define TRUTHCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_TRUTH_ASSET TRUQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_TRUTH_ASSET TRUO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_TRUTH_ASSET TRUR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_TRUTH_ASSET TRUT
...
#endif //TRUTHCOIN_ASSET_PROTOCOL_H
